        ...
        <header className={isBurgClick?'active':''}>
            <div className="headerConteiner">
                ...
                <div className='burgerMenu'>
                    <div className={isBurgClick?'burger active':'burger'} onClick = {()=>BurgerClick()}>
                        <span></span>
                    </div>
